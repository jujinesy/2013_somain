...
public class BaseAsyncTask2 extends AsyncTask<Void, String, Integer>{
	...
	public BaseAsyncTask2(Context context, String title){
		mContext = context;
		this.title = title;
	}
...
//			if(D) Log.d("log_tag", result);
	...
	public static String postRequestFile(String url, HashMap<String, String> valuePair, String filePath, String fileName){
		InputStream is = null;
		String result = "";
